...
def realizar_bisqueda_shodan(api_key, query):
...
if __name__=="__main__":
    ...
    if not api_key:
        ...
        sys.exit("Error. No se ingresó un API key válido")
    #ejemplos de ejecucion apache,apache country:US,"OpenSSH 7.4" port:22, port:554 has_screenshot:true)
    query = input("Ingrese la consulta de bisqueda para Shodan: ").strip()

    realizar_bisqueda_shodan(api_key,query)
